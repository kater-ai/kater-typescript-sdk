...
import { TenantRetrieveSchemaResponse, Tenants } from './tenants/tenants';
...
export declare namespace Connections {
  ...
  export { Tenants as Tenants, type TenantRetrieveSchemaResponse as TenantRetrieveSchemaResponse };
}
