...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['KATER_LOG'] or 'warn' if it isn't set.
   */
...
export class Kater {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Kater.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('KATER_LOG'), "process.env['KATER_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('KATER_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  static KaterError = Errors.KaterError;
