...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('default logLevel is warn', async () => {
      const client = new Kater({ apiKey: 'My API Key', authToken: 'My Auth Token' });
  ...
  test('maxRetries option is correctly set', () => {
    ...
    // default
    const client2 = new Kater({ apiKey: 'My API Key', authToken: 'My Auth Token' });
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['KATER_AUTH_TOKEN'] = 'My Auth Token';
    const client = new Kater();
  ...
  test('with overridden environment variable arguments', () => {
    ...
    process.env['KATER_AUTH_TOKEN'] = 'another My Auth Token';
    const client = new Kater({ apiKey: 'My API Key', authToken: 'My Auth Token' });
    expect(client.apiKey).toBe('My API Key');
    expect(client.authToken).toBe('My Auth Token');
  });
